...
<link rel="stylesheet" href="/proyectoasd/Css/style.css" />
...
<header class="cabecera-institucional">
    ...
    <!-- Lista de opciones del menú hamburguesa (oculta por defecto) -->
     <nav id="nav" class="main-nav">
        <div class="nav-links">
      <a class="link-item" href="/Login/HTML/index.php">Login</a>
      <a class="link-item" href="#estadisticas">Profesores</a>
      <a class="link-item" href="#contenedor-tablas-horarios">Horarios</a>
      <a class="link-item" href="/PHP/anuncios.php">Anuncios</a>
    </div>
</nav>
